...
public class Song extends AudioContent implements Comparable<Song> // implement the Comparable interface
{
	...
	public boolean equals(Object other)
	{
		...
		//Checking if object is an instance of a song class
		if(other instanceof Song){

			//typecasting superclass to subclass 
			Song o = (Song) other;

			//returning the boolean if the songs are equal or not
			return (super.equals(other) && this.composer.equals(o.composer) && this.artist.equals(o.artist));
		}
	...
	public int compareTo(Song other) {
		...
		//Comapring the titles, if equal returning 0 --> else pos or neg
